...
public class MainVerticle extends AbstractVerticle {
  ...
  public void start(Future<Void> fut) {
    ...
    router.post("/").handler(routingContext -> {
      ...
      System.out.println("POST values size: " + values.size());
      String countStr = Integer.valueOf(values.size()).toString();
    ...
    router.get("/metrics").handler(routingContext -> {
      ...
      System.out.println("GET values size: " + values.size());
      ...
      System.out.println("Responding with:  " + builder.toString());
